...
namespace SisRePub
{
    public partial class frmPrintActividades : frmBase
    {
        public frmPrintActividades()
        {
            InitializeComponent();
        }

        private void frmPrintActividades_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cTitulo = "LISTADO DE ACTIVIDADES POR RANGO DE FECHAS";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptActividades orptActividades = new rptActividades();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptActividades.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtActividades, orptActividades, cTitulo);

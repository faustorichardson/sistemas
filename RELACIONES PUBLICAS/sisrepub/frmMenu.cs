...
namespace SisRePub
{
    public partial class frmMenu : Form
    {
        ...
        private void buttonItem1_Click(object sender, EventArgs e)
        {
            frmRegistroActividades ofrmRegistroActividades = new frmRegistroActividades();
            ofrmRegistroActividades.ShowDialog();
        }

        private void buttonItem3_Click(object sender, EventArgs e)
        {
            frmPrintActividades ofrmPrintActividades = new frmPrintActividades();
            ofrmPrintActividades.ShowDialog();
        }

        private void buttonItem4_Click(object sender, EventArgs e)
        {
            frmPrintEstadisticasActividades ofrmPrintEstadisticasActividades = new frmPrintEstadisticasActividades();
            ofrmPrintEstadisticasActividades.ShowDialog();
        }
        ...
        //private void buttonItem17_Click(object sender, EventArgs e)
        //{
        //    frmRegistroOperacionesNarcoticos ofrmRegistroOperacionesNarcoticos = new frmRegistroOperacionesNarcoticos();
        //    ofrmRegistroOperacionesNarcoticos.ShowDialog();
        //}

        //private void buttonItem18_Click(object sender, EventArgs e)
        //{
        //    frmPrintOperacionesNarcoticos ofrmPrintOperacionesAntinarcoticos = new frmPrintOperacionesNarcoticos();
        //    ofrmPrintOperacionesAntinarcoticos.ShowDialog();
        //}

...
namespace SisRePub
{
    public partial class frmPrintEstadisticasActividades : frmBase
    {
        public frmPrintEstadisticasActividades()
        {
            InitializeComponent();
        }

        private void frmPrintEstadisticasActividades_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Clear();
                sbQuery.Append("SELECT actividades.id, COUNT(actividades.tipoactividad) as cantidad, tipoactividad.tipo as tipoactividad");
                sbQuery.Append(" FROM actividades ");
                sbQuery.Append(" INNER JOIN tipoactividad ON actividades.tipoactividad = tipoactividad.id");
                sbQuery.Append(cWhere);
                sbQuery.Append(" GROUP BY actividades.tipoactividad");
                ...
                else
                {
                    ...
                    cTitulo = "ESTADISTICAS DE ACTIVIDADES REALIZADAS";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptEstadisticasActividades orptEstadisticasActividades = new rptEstadisticasActividades();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptEstadisticasActividades.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtActividades, orptEstadisticasActividades, cTitulo);

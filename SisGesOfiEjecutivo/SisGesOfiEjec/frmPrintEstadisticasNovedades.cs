...
{
    public partial class frmPrintEstadisticasNovedades : frmBase
    {
        public frmPrintEstadisticasNovedades()
        {
            InitializeComponent();
        }

        private void frmPrintEstadisticasNovedades_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" tiponovedad.tipo as novedad_tipo, count(tiponovedad.tipo) as novedad_cantidad");
                sbQuery.Append(" FROM novedades ");
                sbQuery.Append(" INNER JOIN tiponovedad ON tiponovedad.id = novedades.novedad_tipo");
                sbQuery.Append(cWhere);
                sbQuery.Append(" GROUP BY tiponovedad.tipo");
                ...
                else
                {
                    ...
                    cTitulo = "ESTADISTICAS DE NOVEDADES EN EL SERVICIO";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptEstadisticasNovedades orptEstadisticasNovedades = new rptEstadisticasNovedades();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptEstadisticasNovedades.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtRegistroNovedades, orptEstadisticasNovedades, cTitulo);

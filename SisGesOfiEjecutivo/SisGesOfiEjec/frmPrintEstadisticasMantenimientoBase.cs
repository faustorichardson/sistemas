...
{
    public partial class frmPrintEstadisticasMantenimientoBase : frmBase
    {
        public frmPrintEstadisticasMantenimientoBase()
        {
            InitializeComponent();
        }

        private void frmPrintEstadisticasMantenimientoBase_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" mantenimientobase.id, mantenimientobase.fecha, COUNT(tipomantenimiento.actividad) as cantidad, ");
                sbQuery.Append(" tipomantenimiento.actividad as tipoactividad");
                sbQuery.Append(" FROM mantenimientobase ");
                sbQuery.Append(" INNER JOIN tipomantenimiento ON tipomantenimiento.id = mantenimientobase.tipoactividad");
                sbQuery.Append(cWhere);
                sbQuery.Append(" GROUP BY tipomantenimiento.actividad");
                ...
                else
                {
                    ...
                    cTitulo = "ESTADISTICAS DE MANTENIMIENTO DE BASE";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptEstadisticasMantenimientoBase orptEstadisticasMantemientoBase = new rptEstadisticasMantenimientoBase();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptEstadisticasMantemientoBase.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtMantenimientoBase, orptEstadisticasMantemientoBase, cTitulo);

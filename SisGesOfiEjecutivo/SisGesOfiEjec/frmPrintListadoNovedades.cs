...
{
    public partial class frmPrintListadoNovedades : frmBase
    {
        public frmPrintListadoNovedades()
        {
            InitializeComponent();
        }

        private void frmPrintListadoNovedades_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" novedades.id, novedades.fecha, novedades.novedad_nota,");
                sbQuery.Append(" tiponovedad.tipo as novedad_tipo, militares.cedula as militar_cedula, militares.rango as militar_rango,");
                sbQuery.Append(" militares.nombre as militar_nombre, militares.apellido as militar_apellido");
                sbQuery.Append(" FROM novedades ");                
                sbQuery.Append(" INNER JOIN tiponovedad ON tiponovedad.id = novedades.novedad_tipo");
                sbQuery.Append(" INNER JOIN militares ON militares.cedula = novedades.oficial_supervisor");
                ...
                else
                {
                    ...
                    cTitulo = "LISTADO DE NOVEDADES";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptListadoNovedades orptListadoNovedades = new rptListadoNovedades();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptListadoNovedades.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtRegistroNovedades, orptListadoNovedades, cTitulo);

...
{
    public partial class frmPrintEstadisticasTarjetas : frmBase
    {
        public frmPrintEstadisticasTarjetas()
        {
            InitializeComponent();
        }

        private void frmPrintEstadisticasTarjetas_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    rptEstadisticasTarjetas orptEstadisticasTarjetas = new rptEstadisticasTarjetas();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptEstadisticasTarjetas.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtTarjetas, orptEstadisticasTarjetas, cTitulo);

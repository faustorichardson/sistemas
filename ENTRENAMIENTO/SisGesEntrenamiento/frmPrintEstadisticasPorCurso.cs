...
{
    public partial class frmPrintEstadisticasPorCurso : frmBase
    {
        public frmPrintEstadisticasPorCurso()
        {
            InitializeComponent();
        }

        private void frmPrintEstadisticasPorCurso_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            if (chkStatus.Checked == true)
            {
                ...
                cTitulo = "ESTADISTICAS DE ENTRENAMIENTOS REALIZADOS";
            ...
            else
            {
                ...
                //nombre del TITULO DEL INFORME
                cTitulo = "ESTADISTICAS DE ENTRENAMIENTOS EN LA ACTUALIDAD";
            ...
            try
            {
                ...
                sbQuery.Clear();
                sbQuery.Append("SELECT cursos.curso, COUNT(entrenamiento.curso) as cantidad");
                sbQuery.Append(" FROM entrenamiento ");
                sbQuery.Append("INNER JOIN cursos ON cursos.id = entrenamiento.curso ");
                //sbQuery.Append("");
                sbQuery.Append(cWhere);
                sbQuery.Append(" GROUP BY entrenamiento.curso");
                ...
                else
                {
                    ...
                    rptEstadisticasCursos orptEstadisticasCursos = new rptEstadisticasCursos();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptEstadisticasCursos.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtEntrenamiento, orptEstadisticasCursos, cTitulo);

...
{
    public partial class frmPrintListadoMilitaresEntrenamiento : frmBase
    {
        public frmPrintListadoMilitaresEntrenamiento()
        {
            InitializeComponent();
        }

        private void frmPrintListadoMilitaresEntrenamiento_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cWhere = cWhere + " AND hasta >= " + "'" + fechadesde + "'" + " AND hasta <= " + "'" + fechahasta + "'" + "";
                sbQuery.Clear();
                ...
                else
                {
                    ...
                    cTitulo = "LISTADO DE MILITARES FINALIZAN ENTRENAMIENTO";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptListadoMilitaresEntrenamiento orptListadoMilitaresEntrenamiento = new rptListadoMilitaresEntrenamiento();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptListadoMilitaresEntrenamiento.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtEntrenamiento, orptListadoMilitaresEntrenamiento, cTitulo);

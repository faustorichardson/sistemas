...
namespace SisGesEntrenamiento
{
    public partial class frmMenu : Form
    {
        ...
        private void buttonItem1_Click(object sender, EventArgs e)
        {        //    frmRegistroVentas ofrmRegistroVentas = new frmRegistroVentas();
        //    ofrmRegistroVentas.ShowDialog();
        }

        private void buttonItem3_Click(object sender, EventArgs e)
        {
            //frmRegistroTarjetas ofrmRegistrarTarjetas = new frmRegistroTarjetas();
            //ofrmRegistrarTarjetas.ShowDialog();
        }
        ...
        private void buttonItem11_Click(object sender, EventArgs e)
        {
            //frmPrintEstadisticasTarjetas ofrmPrintEstadisticasTarjetas = new frmPrintEstadisticasTarjetas();
            //ofrmPrintEstadisticasTarjetas.ShowDialog();
        }

        private void buttonItem5_Click(object sender, EventArgs e)
        {
            //frmPrintTarjetas ofrmPrintTarjetas = new frmPrintTarjetas();
            //ofrmPrintTarjetas.ShowDialog();
        }

        private void buttonItem12_Click(object sender, EventArgs e)
        {
            //frmRegistroNovedades ofrmRegistroNovedades = new frmRegistroNovedades();
            //ofrmRegistroNovedades.ShowDialog();
        }

        private void buttonItem13_Click(object sender, EventArgs e)
        {
            //frmRegistroTipoNovedad ofrmRegistroTipoNovedades = new frmRegistroTipoNovedad();
            //ofrmRegistroTipoNovedades.ShowDialog();
        }
        ...
        private void buttonItem15_Click(object sender, EventArgs e)
        {
            //frmPrintEstadisticasNovedades ofrmPrintEstadisticasNovedades = new frmPrintEstadisticasNovedades();
            //ofrmPrintEstadisticasNovedades.ShowDialog();
        }
        ...
        private void buttonItem17_Click(object sender, EventArgs e)
        {
            //frmRegistroCuentasPorPagar ofrmRegistroCuentasPorPagar = new frmRegistroCuentasPorPagar();
            //ofrmRegistroCuentasPorPagar.ShowDialog();
        }

        private void buttonItem21_Click(object sender, EventArgs e)
        {
            //frmMantenimientoActividades ofrmMantenimientoActividades = new frmMantenimientoActividades();
            //ofrmMantenimientoActividades.ShowDialog();
        }
        ...
        private void buttonItem22_Click(object sender, EventArgs e)
        {
            //frmRegistroMantenimientoBase ofrmRegistroMantenimientoBase = new frmRegistroMantenimientoBase();
            //ofrmRegistroMantenimientoBase.ShowDialog();
        }

        private void buttonItem23_Click(object sender, EventArgs e)
        {
            //frmPrintListadoMantenimientoBase ofrmPrintListadoMantenimientoBase = new frmPrintListadoMantenimientoBase();
            //ofrmPrintListadoMantenimientoBase.ShowDialog();
        }

        private void buttonItem24_Click(object sender, EventArgs e)
        {
            //frmPrintEstadisticasMantenimientoBase ofrmPrintEstadisticasMantenimientoBase = new frmPrintEstadisticasMantenimientoBase();
            //ofrmPrintEstadisticasMantenimientoBase.ShowDialog();
        }

        private void buttonItem1_Click_1(object sender, EventArgs e)
        {
            frmRegistroCurso ofrmRegistroCurso = new frmRegistroCurso();
            ofrmRegistroCurso.ShowDialog();
        }

        private void buttonItem3_Click_1(object sender, EventArgs e)
        {
            frmRegistroEntrenamiento ofrmRegistroEntrenamiento = new frmRegistroEntrenamiento();
            ofrmRegistroEntrenamiento.ShowDialog();
        }

        private void buttonItem2_Click_1(object sender, EventArgs e)
        {
            frmPrintMilitaresPorCurso ofrmPrintMilitaresPorCurso = new frmPrintMilitaresPorCurso();
            ofrmPrintMilitaresPorCurso.ShowDialog();
        }

        private void buttonItem5_Click_1(object sender, EventArgs e)
        {
            frmPrintEstadisticasPorCurso ofrmPrintEstadisticasPorCurso = new frmPrintEstadisticasPorCurso();
            ofrmPrintEstadisticasPorCurso.ShowDialog();
        }

        private void buttonItem11_Click_1(object sender, EventArgs e)
        {
            frmEstadisticasPorCursoRango ofrmEstadisticasPorCursoRango = new frmEstadisticasPorCursoRango();
            ofrmEstadisticasPorCursoRango.ShowDialog();
        }

        private void buttonItem12_Click_1(object sender, EventArgs e)
        {
            frmPrintListadoMilitaresEntrenamiento ofrmPrintListadoMilitaresEntrensamiento = new frmPrintListadoMilitaresEntrenamiento();
            ofrmPrintListadoMilitaresEntrensamiento.ShowDialog();
        }

        private void buttonItem14_Click_1(object sender, EventArgs e)
        {
            frmPrintEstadisticasEscuelas ofrmPrintEstadisticasEscuelas = new frmPrintEstadisticasEscuelas();
            ofrmPrintEstadisticasEscuelas.ShowDialog();
        }
           ...
           // cWhere = cWhere + " AND entrenamiento.curso = " + cmbCurso.SelectedValue + "";
            ...
            try
            {
                ...
                else
                {
                    ...
                    //else
                    //{
                        cTitulo = "LISTADO PERSONAL MILITAR REALIZANDO ENTRENAMIENTO";
                    //}


                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptListadoGeneralCursos orptListadoPorCurso = new rptListadoGeneralCursos();
        ...
        private void buttonItem16_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //else
                    //{
                    cTitulo = "LISTADO PERSONAL MILITAR CURSARON ENTRENAMIENTO";
                    //}
        ...
        //private void buttonItem1_Click(object sender, EventArgs e)
        //{
        //    frmUnidadesNavales ofrmUnidadesNavales = new frmUnidadesNavales();
        //    ofrmUnidadesNavales.ShowDialog();
        //}

        //private void buttonItem3_Click(object sender, EventArgs e)
        //{
        //    frmCombustibleRecibido ofrmCombustibleRecibido = new frmCombustibleRecibido();
        //    ofrmCombustibleRecibido.ShowDialog();
        //}

        //private void buttonItem4_Click(object sender, EventArgs e)
        //{
        //    frmCombustibleGastado ofrmCombustibleGastado = new frmCombustibleGastado();
        //    ofrmCombustibleGastado.ShowDialog();
        //}

        //private void buttonItem14_Click(object sender, EventArgs e)
        //{
        //    frmTipoActividad ofrmTipoActividad = new frmTipoActividad();
        //    ofrmTipoActividad.ShowDialog();
        //}

        //private void buttonItem15_Click(object sender, EventArgs e)
        //{
        //    frmAnularMovimiento ofrmAnularMovimiento = new frmAnularMovimiento();
        //    ofrmAnularMovimiento.ShowDialog();
        //}
        ...
        //        sbQuery.Clear();
        //        sbQuery.Append("SELECT ");
        //        sbQuery.Append("unidades.unidad, condiciones.condicion, tiposcombustibles.combustible as tipocombustible, ");
        //        sbQuery.Append("tipounidades.tipo, unidades.cap_comb as capacidad, existencia.cantidad as existencia ");
        //        sbQuery.Append("FROM unidades ");
        //        sbQuery.Append("INNER JOIN existencia ON existencia.id_unidad = unidades.id ");
        //        sbQuery.Append("INNER JOIN tipounidades ON unidades.tipo = tipounidades.id ");
        //        sbQuery.Append("INNER JOIN tiposcombustibles ON unidades.tipo_comb = tiposcombustibles.id ");
        //        sbQuery.Append("INNER JOIN condiciones ON unidades.condicion = condiciones.id ");
        //        sbQuery.Append(cWhere);
        ...
        //        // Lleno el data adapter
        //        myAdapter.Fill(dtActividad);
        //        // Cierro el objeto conexion
        //        myConexion.Close();

        //        // Verifico cantidad de datos encontrados
        //        int nRegistro = dtActividad.Rows.Count;
        //        if (nRegistro == 0)
        //        {
        //            MessageBox.Show("No Hay Datos Para Mostrar, Favor Verificar", "Sistema Gestion de Combustibles Barcos", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //            return;
        //        }
        //        else
        //        {
        ...
        //            //nombre del TITULO DEL INFORME
        //            cTitulo = "REPORTE DE COMBUSTIBLE ACTUAL UNIDADES NAVALES";

        //            //6to Instanciamos nuestro REPORTE
        //            //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
        //            rptExistenciaCombustible orptExistenciaCombustible = new rptExistenciaCombustible();

        //            //pasamos el nombre del TITULO del Listado
        //            //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
        //            // oListado.SummaryInfo.ReportTitle = cTitulo;
        //            orptExistenciaCombustible.SummaryInfo.ReportTitle = cTitulo;

        //            //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
        //            frmPrinter ofrmPrinter = new frmPrinter(dtActividad, orptExistenciaCombustible, cTitulo);
        ...
        //private void buttonItem6_Click(object sender, EventArgs e)
        //{
        //    frmPrintCombustibleRecibido ofrmPrintCombustibleRecibido = new frmPrintCombustibleRecibido();
        //    ofrmPrintCombustibleRecibido.ShowDialog();
        //}

        //private void buttonItem11_Click(object sender, EventArgs e)
        //{
        //    frmPrintCombustibleGastado ofrmPrintCombustibleGastado = new frmPrintCombustibleGastado();
        //    ofrmPrintCombustibleGastado.ShowDialog();
        //}

        //private void buttonItem12_Click(object sender, EventArgs e)
        //{
        //    frmPrintEstadisticasR ofrmPrintEstadisticasR = new frmPrintEstadisticasR();
        //    ofrmPrintEstadisticasR.ShowDialog();
        //}

        //private void buttonItem13_Click(object sender, EventArgs e)
        //{
        //    frmPrintEstadisticasG ofrmPrintEstadisticasG = new frmPrintEstadisticasG();
        //    ofrmPrintEstadisticasG.ShowDialog();
        //}

        //private void buttonItem16_Click(object sender, EventArgs e)
        //{
        //    frmPrintEstadisticasPorActividad ofrmPrintEstadisticasPorActividad = new frmPrintEstadisticasPorActividad();
        //    ofrmPrintEstadisticasPorActividad.ShowDialog();
        //}

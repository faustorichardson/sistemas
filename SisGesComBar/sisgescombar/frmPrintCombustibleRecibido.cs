...
{
    public partial class frmPrintCombustibleRecibido : frmBase
    {
        public frmPrintCombustibleRecibido()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cTitulo = "REPORTE DE COMBUSTIBLE RECIBIDO EN UNIDADES NAVALES";
        ...
        private void frmPrintCombustibleRecibido_Load(object sender, EventArgs e)
        {

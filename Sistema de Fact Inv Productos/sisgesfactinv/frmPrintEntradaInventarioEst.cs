...
{
    public partial class frmPrintEntradaInventarioEst : frmBase
    {
        public frmPrintEntradaInventarioEst()
        {
            InitializeComponent();
        }

        
        private void frmPrintEntradaInventarioEst_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            string cWhere = " WHERE 1 = 1 AND entrada_inventario.anulada = 0";
            string cUsuario = "";
            string cTitulo = "";
            ...
            try
            {
                ...
                sbQuery.Append(" entrada_inventario_detalle.idproducto, entrada_inventario_detalle.producto,");
                sbQuery.Append(" entrada_inventario_detalle.tipo, sum(entrada_inventario_detalle.cantidad) as cantidad,");
                sbQuery.Append(" entrada_inventario_detalle.cantidad, entrada_inventario_detalle.precio,");
                sbQuery.Append(" SUM(entrada_inventario_detalle.subtotal) as subtotal");
                ...
                sbQuery.Append(" GROUP BY entrada_inventario_detalle.idproducto");
                ...
                else
                {
                    ...
                    cTitulo = "ESTADISTICAS DE ENTRADA A INVENTARIO POR PRODUCTO";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptEntradaInventario_porProducto orptEntradaInventarioxProucto = new rptEntradaInventario_porProducto();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptEntradaInventarioxProucto.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtMovimientoInventario, orptEntradaInventarioxProucto, cTitulo);

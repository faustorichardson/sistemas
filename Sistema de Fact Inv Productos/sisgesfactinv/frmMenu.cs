...
namespace SisGesFactInv
{
    public partial class frmMenu : Form
    {
        ...
        {
            frmAnularEntradaInventario ofrmAnularEntradaInventario = new frmAnularEntradaInventario();
            ofrmAnularEntradaInventario.ShowDialog();
        }

        private void buttonItem11_Click_1(object sender, EventArgs e)
        {
            frmCobroDespachoPedido ofrmCobroDespachoPedido = new frmCobroDespachoPedido();
            ofrmCobroDespachoPedido.ShowDialog();
        }

        private void buttonItem6_Click(object sender, EventArgs e)
        {
            frmFacturacion ofrmFacturacion = new frmFacturacion();
            ofrmFacturacion.ShowDialog();
        }

        private void buttonItem13_Click(object sender, EventArgs e)
        {
            frmAnularFacturacion ofrmAnularFacturacion = new frmAnularFacturacion();
            ofrmAnularFacturacion.ShowDialog();
        }

        private void buttonItem14_Click(object sender, EventArgs e)
        {
            frmGastosAdministrativos ofrmGastosAdministrativos = new frmGastosAdministrativos();
            ofrmGastosAdministrativos.ShowDialog();
        }

        private void buttonItem15_Click(object sender, EventArgs e)
        {
            frmPrintReimpresiones ofrmPrintReimpresiones = new frmPrintReimpresiones();
            ofrmPrintReimpresiones.ShowDialog();
        }
        ...
        private void buttonItem17_Click(object sender, EventArgs e)
        {
            frmPrintGastosAdministrativosSumatoria ofrmPrintGastAdmSum = new frmPrintGastosAdministrativosSumatoria();
            ofrmPrintGastAdmSum.ShowDialog();
        }

        private void buttonItem21_Click(object sender, EventArgs e)
        {
            frmPrintEntradaInventarioEst ofrmPrintEntradaInventarioEst = new frmPrintEntradaInventarioEst();
            ofrmPrintEntradaInventarioEst.ShowDialog();
        }
        ...
        private void buttonItem20_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" inventario.idproducto, inventario.cantidad, productos.producto,");
                sbQuery.Append(" productos.reorden");
                sbQuery.Append(" FROM inventario ");
                sbQuery.Append(" INNER JOIN productos ON inventario.idproducto = productos.idproducto");
                sbQuery.Append(cWhere);
                ...
                // Lleno el data adapter
                myAdapter.Fill(dtInventario);
                // Cierro el objeto conexion
                myConexion.Close();

                // Verifico cantidad de datos encontrados
                int nRegistro = dtInventario.Rows.Count;
                if (nRegistro == 0)
                {
                ...
                else
                {
                    ...
                    //nombre del TITULO DEL INFORME
                    cTitulo = "EXISTENCIA DE PRODUCTOS EN INVENTARIO";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptExistenciaInventario orptExistenciaInventario = new rptExistenciaInventario();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptExistenciaInventario.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtInventario, orptExistenciaInventario, cTitulo);
        ...
        private void buttonItem22_Click(object sender, EventArgs e)
        {
            ...
            // Otras variables del entorno
            string cWhere = " WHERE 1 = 1";
            cWhere = cWhere + " AND inventario.cantidad < productos.reorden";
            string cUsuario = "";
            string cTitulo = "";
            ...
            try
            {
                ...
                else
                {
                    ...
                    //nombre del TITULO DEL INFORME
                    cTitulo = "LISTADO DE PRODUCTOS EN REORDEN";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptProductos_en_Reorden orptProductosEnReorden = new rptProductos_en_Reorden();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptProductosEnReorden.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtInventario, orptProductosEnReorden, cTitulo);
        ...
        private void buttonItem23_Click(object sender, EventArgs e)
        {
            frmPrintFacturacion ofrmPrintFacturacion = new frmPrintFacturacion();
            ofrmPrintFacturacion.ShowDialog();
        }

        private void buttonItem24_Click(object sender, EventArgs e)
        {
            frmPrintFacturacionEst ofrmPrintFacturacionEst = new frmPrintFacturacionEst();
            ofrmPrintFacturacionEst.ShowDialog();
        }

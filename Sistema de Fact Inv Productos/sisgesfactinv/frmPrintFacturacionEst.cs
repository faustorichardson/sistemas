...
{
    public partial class frmPrintFacturacionEst : frmBase
    {
        public frmPrintFacturacionEst()
        {
            InitializeComponent();
        }

        private void frmPrintFacturacionEst_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" facturacion_detalle.idproducto, facturacion_detalle.producto, ");
                sbQuery.Append(" sum(facturacion_detalle.cantidad) as cantidad,");
                sbQuery.Append(" SUM(facturacion_detalle.subtotal) as subtotal");                
                sbQuery.Append(" FROM facturacion ");
                sbQuery.Append(" INNER JOIN facturacion_detalle ON facturacion.idfacturacion = facturacion_detalle.idfacturacion");
                sbQuery.Append(cWhere);
                sbQuery.Append(" GROUP BY facturacion_detalle.idproducto");
                ...
                else
                {
                    ...
                    cTitulo = "ESTADISTICAS DE FACTURACION DE INVENTARIO POR PRODUCTO";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptFacturacionInventario_porProducto orptFacturacionInventarioporProducto = new rptFacturacionInventario_porProducto();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptFacturacionInventarioporProducto.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtMovimientoInventario, orptFacturacionInventarioporProducto, cTitulo);

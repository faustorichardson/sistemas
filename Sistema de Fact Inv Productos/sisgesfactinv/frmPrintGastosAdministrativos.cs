...
{
    public partial class frmPrintGastosAdministrativos : frmBase
    {
        public frmPrintGastosAdministrativos()
        {
            InitializeComponent();
        }

        private void frmPrintGastosAdministrativos_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" gastos.id, gastos.descripcion, gastos.monto, gastos.fecha,");
                sbQuery.Append(" gastos_tipo.desc_tipogasto as categoria");
                ...
                else
                {
                    ...
                    cTitulo = "LISTADO DE GASTOS ADMINISTRATIVOS";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptGastosAdministrativos orptGastosAdministrativos = new rptGastosAdministrativos();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptGastosAdministrativos.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtGastosAdministrativos, orptGastosAdministrativos, cTitulo);

...
namespace SisGesCom
{
    public partial class frmPrintTicketsRecibidos : frmBase
    {
        public frmPrintTicketsRecibidos()
        {
            InitializeComponent();
        }

        private void frmPrintTicketsRecibidos_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Clear();
                sbQuery.Append("SELECT movimientotickets.id, movimientotickets.fecha, movimientotickets.cantidad");                
                ...
                else
                {
                    ...
                    cTitulo = "Listado de Tickets Recibidos";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptPrintListadoTicketsRecibidos orptListadoTicketsRecibidos = new rptPrintListadoTicketsRecibidos();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptListadoTicketsRecibidos.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtTickets, orptListadoTicketsRecibidos, cTitulo);

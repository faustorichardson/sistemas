...
namespace SisGesCom
{
    public partial class frmAnularDespachoCombustible : frmBase
    {
        public frmAnularDespachoCombustible()
        {
            InitializeComponent();
        }

        private void frmAnularDespachoCombustible_Load(object sender, EventArgs e)
        {
            // Limpiando el form
            this.Limpiar();
        }
        ...
        private void ActualizaSalida()
        {
            ...
            try
            {
                ...
                myCommand.CommandText = "UPDATE combustible_salida SET anulada = @anulada, anulada_comentario = @causa WHERE id = " + txtSolicitud.Text + "";
        ...
        private void ActualizarMovimiento()
        {
            ...
            try
            {
                ...
                // Step 3 - Comando a ejecutar
                myCommand.CommandText = "UPDATE movimientocombustible SET anulada = @anulada WHERE id = " + txtSolicitud.Text + " AND tipo_movimiento = 'S'";
                myCommand.Parameters.AddWithValue("@anulada", 1);
        ...
        private void ActualizarExistencia()
        {
            ...
            try
            {
                ...
                myCommand.CommandText = "UPDATE existencia" +
                    ...
                    " WHERE movimientocombustible.id = @anulada AND movimientocombustible.tipo_movimiento = 'S'";
